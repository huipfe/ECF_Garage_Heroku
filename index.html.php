    ...
    <div class="container-fluid p-0 text-light position-relative">
        ...
        <div>
            ...
            start-50 translate-middle">
                <!-- Mobile Bouton -->
                <img src="Assets/images/Bouton_Voiture_mobile.png" class="img-fluid d-lg-none" width="100"
                height="auto" alt="Bouton Voiture">
                <!-- Desktop Bouton -->
                <img src="Assets/images/Bouton_Voiture_desktop.png" class="img-fluid d-none d-lg-block" width="300"
                height="auto" alt="Bouton Voiture2">
            </a>
