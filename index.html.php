...
<main>
    ...
    <div class="container-fluid p-0 text-light position-relative">
        ...
        src="Assets/images/Fond_Voiture_homepage_desktop.png"
        ...
        <div class="position-relative">
            <h2 class="position-absolute bottom-100 start-50 translate-middle bg-dark text-center mt-n5">
                ...
                <br>
            <a href="Testimonials.html.php" class="col-md-4 d-flex align-items-center justify-content-start mb-3 mb-md-0
            me-md-autolink-body-emphasistext-decoration-none position-absolute bottom-30 top-50
            start-50 translate-middle">
                <!-- Mobile Bouton -->
                <img src="Assets/images/Bouton_Voiture_mobile.png" class="img-fluid d-lg-none d-block"
                width="60" height="auto" alt="Bouton Voiture">
                <!-- Desktop Bouton -->
                <img src="Assets/images/Bouton_Voiture_desktop.png" class="img-fluid d-none d-lg-block"
