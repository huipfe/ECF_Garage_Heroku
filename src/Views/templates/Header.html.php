        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                ...
                aria-label="Toggle navigation">
                    ...
                    18.8571V21.102C0 21.598 0.463676 22 1.03571 22Z" fill="#D92332" />
                    </svg>
                        ...
                        <li class="list-inline-item nav-item" style="margin-top: 5px;">
                            <a href="/login/logout">
                                <svg
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.0004 17.5002C11.0004 16.2116 11.3754 15.0105 12.0222
                                    14.0002H4.25278C3.01076 14.0002 2.00391 15.007 2.00391 16.2491V17.169C2.00391
                                    17.7411 2.18231 18.2989 2.51427 18.7648C4.05643 20.9292 6.5794
                                    22.0013 10.0004 22.0013C10.9315 22.0013 11.7962 21.9219 12.5929
                                    21.7626C11.6009 20.6215 11.0004 19.131 11.0004 17.5002ZM10.0004
                                    2.00488C12.7618 2.00488 15.0004 4.24346 15.0004 7.00488C15.0004
                                    9.76631 12.7618 12.0049 10.0004 12.0049C7.23894 12.0049 5.00036
                                    9.76631 5.00036 7.00488C5.00036 4.24346 7.23894 2.00488 10.0004
                                    2.00488ZM23.0004 17.5002C23.0004 20.5378 20.5379 23.0002 17.5004
                                    23.0002C14.4628 23.0002 12.0004 20.5378 12.0004 17.5002C12.0004
                                    14.4627 14.4628 12.0002 17.5004 12.0002C20.5379 12.0002 23.0004
                                    14.4627 23.0004 17.5002ZM18.3539 14.6467C18.1587 14.4515 17.8421
                                    14.4515 17.6468 14.6467C17.4516 14.842 17.4516 15.1586 17.6468
                                    15.3538L19.2932 17.0002H15.0004C14.7242 17.0002 14.5004 17.2241
                                    14.5004 17.5002C14.5004 17.7764 14.7242 18.0002 15.0004
                                    18.0002H19.2933L17.6468 19.6467C17.4516 19.842 17.4516 20.1586
                                    17.6468 20.3538C17.8421 20.5491 18.1587 20.5491 18.3539 20.3538L20.8539
                                    17.8538C20.9071 17.8007 20.9458 17.7385 20.97 17.6723C20.9886
                                    17.6214 20.9992 17.5666 21.0003 17.5095L21.0004 17.5002C21.0004
                                    17.4231 20.9829 17.35 20.9517 17.2848C20.9364 17.2527 20.9175
                                    17.2219 20.8949 17.1931C20.881 17.1753 20.8659 17.1584 20.8498
                                    17.1426L18.3539 14.6467Z"
                                    fill="#D92332"/>
                                </svg>
                            </a>
                        </li>
                ...
                22.6295 0.457646 22.3365C0.750672 22.0434 1.1481 21.8788 1.5625 21.8788H3.39062Z" fill="#D92332" />
                                </svg>
                            </a>
                        </li>
                ...
                <?php else: ?>
                    ...
                    <ul class="d-flex d-lg-none justify-content-end" id="scrolldown-mobile">
                        <li class="list-inline-item nav-item  ps-4" style="margin-right: 20px;"><a href="#copy-right">
                                <svg
                                width="28"
                                height="16"
                                viewBox="0 0 28 16"
                ...
                2.03973 0.207644 0 1.88401 0Z" fill="#D92332" />
                                </svg></a></li>
                    </ul>
                </div>
            </div>
